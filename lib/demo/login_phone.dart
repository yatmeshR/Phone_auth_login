...
import 'package:dits_nexcom/demo/app_dimens.dart';
import 'package:dits_nexcom/demo/app_util.dart';
import 'package:dits_nexcom/demo/verification.dart';
                  ...
                  children: <Widget>[
                    ...
                    Utility.loginButtonsWidget(
                      ...
                      "Continue",
                          () {
                        continueClick();
                        Navigator.push(context, MaterialPageRoute(builder: (builder)=>VerificationScreen(
